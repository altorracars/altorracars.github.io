...
> **▶️ SIGUE = TODO-53 (mandato dueño 06/07): AUDITORÍA HOLÍSTICA diseño+infra** hacia "top mundial". SSoT = spec `2026-07-06-auditoria-holistica-diseno-infra.md`. ✅ **P0.1 (§283) · P1 (§284) · P2 (§285) · P3.1 hero index (§286) · P3.2 vehículos (§287) · P3.3 carrusel (§289) · P3.4 banner marca (§291)**. Colaterales (sesiones hermanas): §288 fix selftest marca CRLF · §290 CI gate. **✅✅ VALIDADO LIVE (deploy `f104708c`)**: homepage prod móvil = **LCP 662ms (era 22.6s), CLS 0.03** — score-killer ELIMINADO en producción. **RESTA (menor)**: optimizar los 18 banners marca (PNG 73-331KB → WebP/AVIF) · render-blocking (inconsistente) · minify (decisión build). El dueño puede correr PageSpeed oficial para el score exacto. Bloqueados sin dinero: flip LLM #917 · Cloudflare. Cadencia §0.b.
>
...
| **TODO-53** | **🔎 AUDITORÍA HOLÍSTICA diseño+infra ⟦OPUS⟧ (mandato dueño 06/07)** — spec `2026-07-06-auditoria-holistica-diseno-infra.md`. P0.1 masonry ✅ (§283) · **P1 ✅ (§284)** · **P2 ✅ (§285)** · **P3.1 LCP hero ✅ (§286)** · **P3.2 LCP vehículos ✅ (§287)** · **P3.3 carrusel reflow ✅ (§289)** · **P3.4 banner marca ✅ (§291)**. **✅✅ VALIDADO LIVE**: prod LCP 662ms (era 22.6s), CLS 0.03. RESTA (menor): banners marca PNG→WebP · render-blocking · minify · P0 barrido panel (extensión) + P4 extensión Chrome. | 🔄 impl | menor/panel |
