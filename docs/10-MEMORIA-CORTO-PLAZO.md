...
> **▶️ SIGUE = TODO-53 (mandato dueño 06/07): AUDITORÍA HOLÍSTICA diseño+infra** hacia "top mundial". SSoT = spec `2026-07-06-auditoria-holistica-diseno-infra.md` (P0 panel · P1 a11y · P2 CLS · P3 minify/perf · P4 extensión Chrome). ✅ P0.1 grilla Atributos→masonry (`4e35145a`, §283). ✅ **P1 a11y** (§284, `d349ecb2`): qt-dock toolbar · footer 1.83→7.81:1 AAA · CTA 24px · 0 botones sin nombre. ✅ **P2 CLS/perf** (§285, `f42e3ff5`): único gap real = preconnect 4→2+dns-prefetch (index+3 templates); resto YA OK por OLA 0-3 (img w/h presentes · CLS 0.034 good · JS defer+CSS media=print · animaciones peso-0 diferidas). **NEXT: P3 = el score-killer real → LCP móvil 22.6s** (minify JS/CSS 142+32 KiB · unused 690+87 KiB · payload 8.6 MiB). Bloqueados sin dinero: flip LLM #917 · Cloudflare. Otros gates dueño aparcados (MFA/AppCheck/cutover/GSC §276.7). Cadencia §0.b.
>
...
| **TODO-53** | **🔎 AUDITORÍA HOLÍSTICA diseño+infra ⟦OPUS⟧ (mandato dueño 06/07)** — spec `2026-07-06-auditoria-holistica-diseno-infra.md`. P0.1 masonry ✅ (§283) · **P1 a11y ✅ (§284)** · **P2 CLS/perf ✅ (§285)**. RESTA: **P3 minify/unused JS-CSS (LCP móvil 22.6s = score-killer real)** · P0 barrido panel (extensión) + P4 extensión Chrome. | 🔄 impl | P3 next |
