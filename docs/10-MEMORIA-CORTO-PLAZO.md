...
> **⛔ Gate de lanzamiento (pendiente, NADA desplegado)**: (1) **blindaje** P0 (App Check + `maxInstances` + firma webhook Telegram) → P1 (**SEC-01 RBAC-read = Decisión Fuerte: Gemini/§15 + OK del cliente + emulator ANTES del deploy MANUAL**); (2) **LEGAL-01..06** con abogado (privacidad/T&C/garantía usados); (3) E2E "cero pérdida". Detalle en `41`/`42`.
>
