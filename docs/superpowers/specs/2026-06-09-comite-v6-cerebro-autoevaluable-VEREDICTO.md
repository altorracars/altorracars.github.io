...
- [ ] **C · los-3** — ⚠️ **Decisión de confidencialidad pública** (prompt Gemini LISTO → `specs/2026-06-09-gemini-exposicion-publica-prompt.md`; espera al cliente) (cliente + consejo Gemini, Trigger Decisión Fuerte): triage de 41-SEGURIDAD/research-archive/crm-handoff servidos por GitHub Pages → redactar / repo privado hermano / aceptación documentada · acepta: ADR con la política + contenido triado o aceptación firmada · depende: A
...
- [ ] **H · bersaglio** — GC dos palancas + curas del canon (PARCIAL: "Gemini":215→consejo externo ✅ · performance-check fantasma retirada ✅ · resto pendiente): 6 TODOs ✅ fuera de la tabla · bitácora §47-§55 podada · CLAUDE.md < cap · "Gemini":215 → "consejo externo" · ejemplo regla-de-oro de 00 reescrito · 20-ESPACIAL:102 Morosos → desplegado · PENDIENTES-Y-HALLAZGOS actualizado o a _legacy/ + referenciado · "performance-check" fantasma fuera de 40:16 · caps bajados mismo commit · acepta: BOOT ≤ objetivo (o ADR) + greps · depende: G
...
> **Estado (2026-06-09, 2ª pasada)**: **A,B,D,E,F,G,I,J,K ✅** · H parcial · **C = decisión del CLIENTE** (prompt Gemini listo) · L,M,N,O,P,Q,R,S,T,U pendientes. Commits: cars `9b00057`+kernel · bersaglio `a030069` · inmobiliaria `04c0105`.
