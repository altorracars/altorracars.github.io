...
|---|---|
| **Build** | 🟢 código @ `5e8c4762` (`dev`): **🤖 OPUS 4.8 · PLAN MAESTRO=SSoT**. 🏁 OLA 0-3 ✅ (§267-282). TODO-53 ✅ LIVE (§283-295, LCP 662ms). **⚡ TODO-54 PERF v2:** ✅ LIVE búsqueda 40→65 · home 55→61; §297 self-host fuentes; **§298 Ola 1 (logo 412KB→ligeros + diferir GSI, verif live)**. **Diagnóstico LH: ord 95 (≈Apple 94) · móvil 57** (Artifact; CrUX vacío = falta tráfico, no bug). **Techo home = Cloudflare 🚫 BLOQUEADO** (no re-preguntar). **🧭 perf-v2 sigue: Ola 2 reCAPTCHA/AppCheck (gate Firebase Console) · re-medir · TODO-52 CRM.** **Gates dueño:** flip LLM #917 · MFA 2.9 · App Check 2.11 · cutover 2.12b · saldo/purga · validar-live (§274) · GSC §276.7. |
