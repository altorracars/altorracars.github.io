...
let DEAL_SEQ = 100;
const MOCK_DEALS = [
  { id: 'd1', name: 'Diana Ramírez · Chevrolet Tracker 2023', contactName: 'Diana Ramírez', contactId: 'email_diana_r_hotmail_com', leadId: 'l3', vehicleId: 'chevrolet-tracker-2023', vehicleName: 'Chevrolet Tracker 2023', pipelineId: 'ventas', stageId: 'cuadrando_cita', stageName: 'Cuadrando cita', status: 'open', amount: 82000000, currency: 'COP', probability: 0.20, weightedAmount: 16400000, ownerId: 'u_ana', ownerName: 'Ana Restrepo', source: 'web', lastActivityAt: hoursAgo(2), createdAt: hoursAgo(5), _version: 2 },
  { id: 'd2', name: 'Laura Valentina Ortiz · Kia Sportage 2022', contactName: 'Laura Valentina Ortiz', contactId: 'email_lauraortiz_gmail_com', leadId: 'l5', vehicleId: 'kia-sportage-2022', vehicleName: 'Kia Sportage 2022', pipelineId: 'ventas', stageId: 'cita_fijada', stageName: 'Cita fijada', status: 'open', amount: 95000000, currency: 'COP', probability: 0.35, weightedAmount: 33250000, ownerId: 'u_luis', ownerName: 'Luis Pérez', source: 'bot', lastActivityAt: hoursAgo(20), createdAt: daysAgo(1), _version: 3 },
  { id: 'd3', name: 'Andrés Felipe Cuesta · Mazda 3 2021', contactName: 'Andrés Felipe Cuesta', contactId: 'email_afcuesta_gmail_com', leadId: 'l8', vehicleId: 'mazda-3-2021', vehicleName: 'Mazda 3 2021', pipelineId: 'ventas', stageId: 'visita_test_drive', stageName: 'Visita / Test drive', status: 'open', amount: 68000000, currency: 'COP', probability: 0.50, weightedAmount: 34000000, ownerId: 'u_ana', ownerName: 'Ana Restrepo', source: 'web', lastActivityAt: daysAgo(18), createdAt: daysAgo(20), _version: 5 },
  { id: 'd4', name: 'Roberto Gómez · Toyota Hilux 2020', contactName: 'Roberto Gómez', contactId: 'phone_573001239876', leadId: null, vehicleId: 'toyota-hilux-2020', vehicleName: 'Toyota Hilux 2020', pipelineId: 'ventas', stageId: 'negociacion', stageName: 'Negociación', status: 'open', amount: 135000000, currency: 'COP', probability: 0.70, weightedAmount: 94500000, ownerId: 'u_luis', ownerName: 'Luis Pérez', source: 'whatsapp', lastActivityAt: hoursAgo(6), createdAt: daysAgo(8), _version: 7 },
  { id: 'd5', name: 'Sandra Milena Vélez · Renault Duster 2022', contactName: 'Sandra Milena Vélez', contactId: 'email_smvelez_gmail_com', leadId: null, vehicleId: 'renault-duster-2022', vehicleName: 'Renault Duster 2022', pipelineId: 'ventas', stageId: 'cuadrando_cita', stageName: 'Cuadrando cita', status: 'open', amount: 0, currency: 'COP', probability: 0.20, weightedAmount: 0, ownerId: null, ownerName: null, source: 'cuenta', lastActivityAt: hoursAgo(1), createdAt: hoursAgo(1), _version: 1 },
  // E4/F26: colisión comercial — d9 compite con d4 por la MISMA Hilux (demo del warning).
  { id: 'd9', name: 'Patricia Lemus · Toyota Hilux 2020', contactName: 'Patricia Lemus', contactId: 'phone_573009871234', leadId: null, vehicleId: 'toyota-hilux-2020', vehicleName: 'Toyota Hilux 2020', pipelineId: 'ventas', stageId: 'cita_fijada', stageName: 'Cita fijada', status: 'open', amount: 132000000, currency: 'COP', probability: 0.35, weightedAmount: 46200000, ownerId: 'u_ana', ownerName: 'Ana Restrepo', source: 'walkin', lastActivityAt: hoursAgo(3), createdAt: daysAgo(2), _version: 2 },
  // ── Deals cerrados (ganados/perdidos) → win-rate, valor ganado e ingresos por fuente en Reportes §165 ──
  // E4/F10+F42: d6 con checklist a medias (⏳ pendiente) + retoma; d7 completo (✓ liquidable).
  { id: 'd6', name: 'Mauricio Bedoya · Mazda CX-5 2021', contactName: 'Mauricio Bedoya', contactId: 'email_mbedoya_gmail_com', leadId: 'l11', vehicleId: 'mazda-cx5-2021', vehicleName: 'Mazda CX-5 2021', pipelineId: 'ventas', stageId: 'vendido', stageName: 'Vendido', status: 'won', amount: 78000000, currency: 'COP', probability: 1, weightedAmount: 78000000, ownerId: 'u_ana', ownerName: 'Ana Restrepo', source: 'facebook', lastActivityAt: daysAgo(3), createdAt: daysAgo(10), _version: 6, tipoPago: 'financiado', wonAt: daysAgo(3), postventa: { entrega: true, traspaso_runt: false, tramites: false }, commissionSnapshot: { amount: 78000000, tipoPago: 'financiado', ownerId: 'u_ana', wonAt: daysAgo(3) }, recibeVehiculo: { marca: 'chevrolet', modelo: 'Spark GT', placa: 'XYZ789', valorEstimado: 28000000 } },
  { id: 'd7', name: 'Yuliana Castaño · Toyota Hilux 2020', contactName: 'Yuliana Castaño', contactId: 'email_yulycastano_gmail_com', leadId: 'l12', vehicleId: 'toyota-hilux-2020', vehicleName: 'Toyota Hilux 2020', pipelineId: 'ventas', stageId: 'vendido', stageName: 'Vendido', status: 'won', amount: 112000000, currency: 'COP', probability: 1, weightedAmount: 112000000, ownerId: 'u_luis', ownerName: 'Luis Pérez', source: 'whatsapp', lastActivityAt: daysAgo(5), createdAt: daysAgo(15), _version: 7, tipoPago: 'contado', wonAt: daysAgo(5), postventa: { entrega: true, traspaso_runt: true, tramites: true }, commissionSnapshot: { amount: 112000000, tipoPago: 'contado', ownerId: 'u_luis', wonAt: daysAgo(5) } },
