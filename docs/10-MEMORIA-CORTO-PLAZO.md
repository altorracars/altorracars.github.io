...
- **EN CURSO: SP-5.2 body migration soft pages — DECOMPUESTO en 3 lotes** (es un PORT;
  ...
  - **SP-5.2.c**: App-like (contenido generado por JS — reescribir el render a cinematic
    ...
    - **SP-5.2.c.2 COMPLETO** (perfil §131 + favoritos §132). **← RETOMAR AQUÍ: c.3 comparar** (brainstorm propio — ver "MEJORAS DEL COMPARADOR" abajo) y c.4 simulador (sprint propio, 2389 líneas).
