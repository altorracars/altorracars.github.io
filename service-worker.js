...
const CACHE_VERSION = 'v20260506050000'; // RCA STRUCTURAL FIX — eliminado MutationObserver de icons.js (causa raíz de clicks bloqueados) + admin-header-fix.js eliminado + meta tag + clientes rules editor+
