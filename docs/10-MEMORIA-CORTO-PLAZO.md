...
> **▶️ SIGUE = TODO-53 (mandato dueño 06/07): AUDITORÍA HOLÍSTICA diseño+infra** hacia "top mundial". SSoT = spec `2026-07-06-auditoria-holistica-diseno-infra.md`. ✅ **P0.1 masonry (§283) · P1 a11y (§284) · P2 CLS/perf (§285) · P3.1 LCP hero (§286: CSS bg-image→`<picture>` preloaded → móvil 22.6s→720ms, CLS 0)**. **NEXT resto P3**: (a) heroes detalle/marca (¿mismo patrón bg-image?) · (b) render-blocking CSS (trace FCP −2766ms, pero es CSS crítico "Task 7" riesgoso) · (c) minify+unused JS/CSS · (d) main-thread/forced-reflow. Bloqueados sin dinero: flip LLM #917 · Cloudflare. Cadencia §0.b.
>
...
| **TODO-53** | **🔎 AUDITORÍA HOLÍSTICA diseño+infra ⟦OPUS⟧ (mandato dueño 06/07)** — spec `2026-07-06-auditoria-holistica-diseno-infra.md`. P0.1 masonry ✅ (§283) · **P1 ✅ (§284)** · **P2 ✅ (§285)** · **P3.1 LCP hero ✅ (§286: 22.6s→720ms)**. RESTA: P3 (heroes interiores · minify/unused JS-CSS · main-thread) · P0 barrido panel (extensión) + P4 extensión Chrome. | 🔄 impl | P3 resto |
