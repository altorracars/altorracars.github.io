...
export const BOOTSTRAP_FAQS = [
  ...
  { question: '¿A cuántos meses puedo financiar?', answer: 'Puedes financiar de **12 a 72 meses** (1 a 6 años) según el banco y tu perfil crediticio. La aprobación final la da el banco en 24-48 horas.', keywords: ['plazo', 'meses', 'cuanto tiempo financiar', 'cuantos años', 'a cuantos meses'], category: 'financiacion', priority: 88 },
