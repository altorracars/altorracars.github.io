...
|---|---|
| **Build** | 🟢 **CRM E0→E5 ✅. E6** ②/③ ✅ + Vehículos V1-V5 + Dealers FASE 1 — **EN MAIN**. **Verif. INICIAL V6 + fix HECHO (ADR §209)**: walk-in blocker (`createManualLead` permission-denied, regresión SEC-06/L-41) → **rama admin rules §209 DEPLOYADA**; reasignar rollback §3.6. **§210 gates ②/③ 5/6 MERGEADO/LIVE** (`admin-cutover-gates.js`; vehículos tras V6). **④ RBAC §193.4 en DISEÑO** (comité). ⏳ dueño: verif EN VIVO del lote V6 → desbloquea vehículos. Dealers F2 gated. |
