...
| §223 | **§G.4 kernel cross-repo: Reflejo de Caza-bugs byte-idéntico ×4 (handoff bersaglio §90.8/TODO-26) ⟦OPUS-4.8⟧** — guardián cars (L-31); se eliminó `(§3.7)` repo-específico (byte-identidad+correctitud §3.3); gates opcionales: §90.8 DECLINADO (heurística frágil ×4), TODO-22-bsg DIFERIDO (choca con §208.2 abolir-estado-dinámico), TODO-23-bsg→TODO-30. Las 4 §G aún NO byte-idénticas (TODO-28 pend; este es el 1er bullet idéntico). | 43791 |
