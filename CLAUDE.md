...
| 🧊 **Pendientes congelados** | `docs/11-PENDIENTES-CONGELADOS.md` | ❌ on-demand | Los 25 TODO de cars, **en PAUSA (§302), no cerrados**. Salieron del boot el 01/08: costaban 4.5k por sesión para trabajo que nadie iba a tomar. **Leer cuando el dueño diga «volvemos a cars»** — y devolverlos al `10` (el shard fue por pausa, no por tamaño). |
