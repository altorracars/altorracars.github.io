...
> **Captura AUTO completa** (web+cuenta+newsletter). **Bot ALTOR** = DIFERIDO (buggy). **Próximo: Fase 4 (Reportes/KPIs)** con atribución de fuente completa, o migrar Inventario/Config al portal → **cutover**. Roadmap → `crm-handoff.md §9.5/§9.6`.
>
