...
| §220 | **CMS (TODO-23) arranque: comité v4+Gemini + FASE 0 seguridad ⟦OPUS-4.8⟧** — editor de fichas tipadas en `admin-app/`; FASE 0 hardening (safeJsonLd/escapeAttr/anti-svg/anchor-guard; gate `SSG_SELFTEST`). Detalle→99/bóveda. | 43739 |
