...
## 🚗 App CRM nueva (`admin-app/`) → hoja hija `21-ESPACIAL-ADMIN.md`

El detalle espacial del **portal admin** (`admin-app/`: estructura de módulos, ruteo, patrón de
estado entre módulos, canales de ingestión al canónico, inteligencia determinista) vive en
**`docs/21-ESPACIAL-ADMIN.md`** (shard §G.5 · §159/§237/§255). Consúltala ante Trigger de
Desorientación SOBRE EL CRM. (Esta neurona `20` cubre lo público/repo/schema.)
