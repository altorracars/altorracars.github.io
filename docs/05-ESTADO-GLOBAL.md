...
|---|---|
| **Build** | 🟢 `main`: CRM canónico + E6 + RBAC ④a (④b parqueado) + CMS marca + F4/F5/§237/F-0.5 ✅ (dueño mergeó #938-945). **`dev` adelante: F-2 1-5/6** (`usuarios` §238 · `roles` §240 · `departamentos` §241 · `workflows` §242 · `auditoria` §243; source; falta 6/6 Ajustes). **⚠️ dist admin-app GATEADO a staging** (batch F-0.5 multiTab/RTDB + F-2 sale junto tras E2E; §237.6). |
