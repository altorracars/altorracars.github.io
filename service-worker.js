...
const CACHE_VERSION = 'v20260511140000'; // §49 — Unificación de seguridad personal en Mi Perfil: (1) Cambiar contraseña movido de sec-settings a sec-profile (IDs #changePasswordForm + handler en admin-auth.js intactos). (2) Dispositivos de Confianza movidos de sec-settings a sec-profile (IDs #trustedDevicesList + #btnRevokeAllDevices intactos). (3) NUEVO: toggle 2FA on/off + cambio de teléfono en Mi Perfil (perdido en migración a topnav §36). Status visual: "Activo · *********6747" o "Desactivado". Form expandible con checkbox + prefijo (7 países) + número, validaciones 7-12 dígitos. Persiste en Firestore habilitado2FA + telefono2FA + prefijo2FA. (4) sec-settings ahora solo: themePicker + SEO Tools + Respaldo de Datos JSON. // §48 — Sistema de recuperación.
