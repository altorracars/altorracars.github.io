...
const CACHE_VERSION = 'v20260511090000'; // §47.bis — 2 fixes mobile: (1) Isla dinámica drag NO funcionaba en mobile/tablets. Causa: media query @media(max-width:720px) con !important pisaba style.left/top que setea JS. Fix: clase .alt-presence-island--positioned se agrega en pointerdown y media query ahora :not(--positioned). Threshold mobile aumentado a 8px (touch necesita mas tolerancia que mouse). (2) Overflow horizontal mobile: cards "Citas" cortadas y contenido fuera del viewport. Causa: admin-v2.css con !important fuerza minmax(220px) que NO colapsa a 1 col en viewports <600px. Fix: append a admin-perf-kill.css con specificity .admin-panel + media queries (max-width:600px) 1 col, (601-900px) 2 cols, anti-overflow global, padding fluid, modales full-width, tablas con scroll-x interno, topnav compactado <480px. // §47 base — 2FA mobile fixes.
