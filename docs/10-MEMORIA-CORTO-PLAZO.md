...
> ✅ **1.6+1.7+1.8-core HECHOS** (03-04/07: chrome SVG · validate.js+_version+rules-shape (suite 347/347, deployed) · z-tokens 100% + rev-modal premium + hub tokens + contraste oro + empty-CTAs).
> **▶️ SIGUE (plan §Ola 1):** 1.8b skeletons top-5 (contactos/vehículos/agenda/hub/usuarios — patrón components.css:178) → 1.9 onboarding novato + combobox typeahead conversión → 1.9b cola offline-rechazos. Luego OLA 2.
