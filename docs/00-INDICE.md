...
| §258 | **Kernel shard-aware ⟦OPUS⟧** — `brain-check.mjs` lee el índice como SET (`00`+`00[a-z]-INDICE*`) en #3/#5a/#9 → habilita range-shard; backward-compat. ×4 byte-idéntico (L-31). Aplicación=bersaglio §140. | 44251 |
