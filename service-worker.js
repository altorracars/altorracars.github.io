...
const CACHE_VERSION = 'v20260510280000'; // §34 ADMIN OVERHAUL — Cards components reemplazan tablas legacy en Vehiculos/Marcas/Reseñas (av2-card-list grid + Mica + content-visibility + contain). Vehiculos: thumbnail prominente + status pill + price card + featured badge + reorder mode adaptado a cards via initCardsDragDrop. Marcas: gallery con logo prominente + count vehiculos. Reseñas: cards con avatar + stars + quote 3-line clamp. FIX XSS critico en Banners + Reseñas: removido onclick="..." inline + agregado escapeHtml en _docId/imgThumb + delegacion data-action. AltorraSectionCleanup wired en 7 modulos (appointments, reviews, banners, dealers, concierge, crm, vehicles drafts) — onSnapshot/setInterval ahora se cancelan al cambiar seccion. Eliminado MutationObserver subtree:true en admin-sidebar.js (regresion CLAUDE.md §17.12 que causo bug clicks bloqueados) — reemplazado por suscripcion AltorraSections.onChange. Cero !important nuevos. Cero parches v1/v2/v3 — extension microquirurgica de admin-v2.css.
