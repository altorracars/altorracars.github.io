...
|---|---|
| **Build** | 🟢 código @ `f60baf2c` (`dev`): **🤖 OPUS 4.8 · arranque §0+§0.b · PLAN MAESTRO=SSoT**. 🏁 OLA 0-3 ✅ (§267-282). TODO-53 pública ✅ LIVE (§283-295, LCP 662ms). **⚡ TODO-54 PERF v2 (spec `2026-07-09-perf-4surfaces` = SSoT):** ✅✅ LIVE **BÚSQUEDA 40→65 · HOME 55→61** (FCP/LCP transformados); admin App Check diferido; extend-diet a páginas de contenido. **Techo home = Cloudflare = 🚫 BLOQUEADO sin presupuesto** (dueño: NO re-preguntar, 09/07). **🧭 2 hilos frescos: perf-v2 (re-medir admin·lazy-routes·fuentes) · TODO-52 CRM.** **Gates dueño:** flip LLM #917 · MFA 2.9 · App Check 2.11 · cutover 2.12b · saldo/purga · validar-live (§274) · GSC §276.7. |
