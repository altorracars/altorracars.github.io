...
|---|---|
| **Build** | 🟢 `main`==`dev` (sync) · código @ `cbe88243`: **🤖 OPUS 4.8 · arranque §0+§0.b · PLAN MAESTRO=SSoT**. 🏁 ARCO OLA 0-3 ✅ (§267-282). **TODO-53 pública** ✅ (§283-291; LIVE `f104708c` LCP 662ms/CLS 0.03). **TODO-52 PANEL** ✅ grillas+responsive móvil (§292-295). **⚡ TODO-54 PERF (§296) EN CURSO:** Fase 0+1.1a+1.2a+2.1a ✅ LIVE — payload ~5.3→2.7MB, a11y/agéntica **100**, reCAPTCHA diferido; RESTA 2.1b/2.2/2.4/2.6 (spec `2026-07-08-pagespeed-audit-plan.md`). **Directiva permanente TODO-52** (pulir→top). **Gates dueño:** flip LLM #917 · MFA 2.9 · App Check 2.11 · cutover 2.12b · saldo/purga · validar-live (§274) · GSC §276.7. |
