...
export const BOOTSTRAP_FAQS = [
  { question: '¿Dónde están ubicados?', answer: 'Estamos en Cartagena, Bolívar, Colombia. Atendemos clientes de toda la Costa Caribe. Si querés agendar una visita, decime "agendar cita" y te conecto con un asesor.', keywords: ['ubicacion', 'donde estan', 'donde quedan', 'cartagena', 'sede', 'direccion', 'como llego'], category: 'ubicacion', priority: 90 },
  { question: '¿Cuál es el horario de atención?', answer: 'Atendemos de **Lunes a Sábado de 8:00 AM a 6:00 PM**. Domingos cerrado. Si tenés alguna urgencia, escribime aquí y te conecto con un asesor por WhatsApp.', keywords: ['horario', 'cuando abren', 'atienden hoy', 'hasta que hora', 'abren domingo'], category: 'horarios', priority: 90 },
  { question: '¿Cuál es el número de teléfono / WhatsApp?', answer: 'Nuestro número es **+57 323 501 6747** 📲 con WhatsApp activo. También me podés escribir aquí mismo y te conecto con un asesor humano al instante.', keywords: ['telefono', 'celular', 'whatsapp', 'numero', 'contacto'], category: 'general', priority: 85 },
  ...
  { question: '¿Cuál es la cuota inicial mínima?', answer: 'La cuota inicial mínima es del **30% del valor del vehículo**. A mayor cuota inicial, menor es la cuota mensual. Si necesitás simular escenarios distintos, podemos ayudarte con eso.', keywords: ['cuota inicial', 'inicial', 'enganche', 'minimo', 'prima', 'que pongo de inicial'], category: 'financiacion', priority: 90 },
  ...
  { question: '¿Quiero vender mi auto, cómo funciona la consignación?', answer: 'En consignación nosotros lo **vendemos por vos**: lo exhibimos, hacemos el marketing, atendemos llamadas, mostramos el auto, todo. Vos solo recibís la plata cuando se vende. **Sin costo si lo vendemos nosotros**. Primero hacemos un peritaje gratuito y te damos un precio sugerido. ¿Te interesa?', keywords: ['consignar', 'consignacion', 'vender mi auto', 'venta de mi carro', 'pongo en venta', 'reciben mi auto'], category: 'consignacion', priority: 90 },
  ...
  { question: '¿Qué tipos de vehículos manejan?', answer: 'Manejamos **SUVs, sedanes, hatchbacks y pickups** de las marcas más confiables (Toyota, Mazda, Chevrolet, Renault, Kia, Hyundai, Nissan, Ford). Tanto **usados como semi-nuevos**. Decime qué andás buscando y te muestro opciones.', keywords: ['que tipos', 'que manejan', 'que venden', 'que carros tienen', 'que marcas'], category: 'inventario', priority: 88 },
  ...
  { question: '¿Negocian el precio?', answer: 'Para hablar de **rebajas y precios finales** necesitás conectar con un asesor humano. Ellos manejan los descuentos según el caso. Decime "hablar con asesor" y te conecto al instante.', keywords: ['rebaja', 'descuento', 'negociable', 'precio final', 'minimo', 'mejor precio', 'le hago'], category: 'general', priority: 80 },
  ...
  { question: '¿Quién es ALTOR?', answer: 'Soy **ALTOR**, el asistente virtual de Altorra Cars 🤖. Te ayudo 24/7 con consultas rápidas, mostrarte el inventario, agendar visitas. Si necesitás algo más complejo, te conecto con un asesor humano al instante.', keywords: ['quien eres', 'que eres', 'eres bot', 'eres humano', 'altor', 'inteligencia artificial'], category: 'general', priority: 70 },
  { question: '¿Cómo agendo una visita?', answer: 'Para agendar una visita decime **"quiero agendar"** o **"hablar con asesor"** y te conecto con un humano que te coordina la fecha y hora. También podés escribir directo al WhatsApp +57 323 501 6747.', keywords: ['agendar', 'cita', 'visita', 'cuando puedo ir', 'verlo en persona', 'cuadrar'], category: 'general', priority: 92 },
  { question: '¿Qué pasa si el auto que me gusta tiene falla?', answer: 'Antes de venderse, **todos pasan por peritaje técnico**. Si después de comprarlo aparece una falla cubierta por garantía (90 días motor/caja), lo reparamos sin costo. Si querés, podés también **pedir un peritaje externo** antes de comprar — lo aceptamos sin problema.', keywords: ['falla', 'problema', 'rompe', 'garantia mecanica', 'peritaje externo', 'tercero'], category: 'politica', priority: 78 },
  { question: '¿Aceptan motos como parte de pago?', answer: 'Recibimos **motos de marcas reconocidas** (Yamaha, Honda, Suzuki, Kawasaki, Bajaj) como parte de pago. Hacemos avalúo gratuito. Decime qué moto tenés y te oriento.', keywords: ['moto', 'motocicleta', 'permuta moto', 'cambio mi moto'], category: 'consignacion', priority: 65 },
  { question: '¿Cuánto rinde un auto en gasolina?', answer: 'Depende del modelo y motor. Como referencia: **autos pequeños/sedanes 1.6L → 35-45 km/galón**, **SUVs medianas → 30-38 km/galón**, **pickups → 25-32 km/galón**. Si me decís qué modelo te interesa, te paso el dato exacto.', keywords: ['rendimiento', 'consumo', 'gasolina', 'km por galon', 'cuanto rinde', 'gasta mucho'], category: 'inventario', priority: 70 },
];
