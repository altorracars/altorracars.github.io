...
|---|---|
| **Build** | 🟢 **CRM E0→E5 ✅. E6** ②/③ ✅ + **Vehículos V1-V5** (§199-203) + **Dealers FASE 1** (§204) — **EN MAIN**. **Verif. INICIAL V6 + fix de sus 2 hallazgos HECHO (ADR §209, 17/06)**: walk-in blocker (`createManualLead` permission-denied, regresión SEC-06/REINCIDENCIA L-41) → **rama admin rules §209 DEPLOYADA**; reasignar rollback §3.6. Emulador e6 5/5 · suite 198/198 · build ✓ · cache NO bump (§3.8). ⏳ Pendiente: dueño `git push`+merge del commit del fix (code/dist) + verificación EN VIVO → luego gates ②/③. Dealers FASE 2 gated (TODO-25). |
