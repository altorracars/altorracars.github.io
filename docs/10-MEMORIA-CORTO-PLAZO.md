...
| **TODO-39** | **🧭 PLAN UNIFICADO un-solo-panel-admin ⟦OPUS-4.8⟧ — FOCO MAESTRO** (spec `…PLAN-UNIFICADO…`). Portal único `admin-app/`, apagar `admin.html`. Survey+comité+Gemini verif (6 hallazgos). **F-0.5 ✅ · F-2 1-5/6 ✅** (Usuarios §238 · Roles §240 · Deptos §241 · Workflows §242 · Auditoría §243; dist gateado a staging); camino F0..F6 → foco/RESUME arriba. **F4/F5 (bot v2) consolidado §236, su resto = F-1 aquí.** | 🔄 F-2 (5/6) | dueño: dinero/legal/go-no-go |
