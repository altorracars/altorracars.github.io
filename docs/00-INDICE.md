...
| §150 | **Consistencia de diseño global** (post-QA): de-blue→**near-black cálido** (paleta cinematic era índigo; calentada+oscurecida a `#0D0B09` en 9 CSS, `--cin-bg` intacto) + skip-link §149 REMOVIDO (cliente, A11Y-04→5/6) + QuickTools dock siempre visible + dropdown "Vehículos" abre por hover CSS en todas las páginas. §150/b commiteados, §150.c SIN commit. ⏳ Validación visual + layout dropdown index (screenshot) | 42781 |
