...
| **TODO-28** | **Cerebro: des-saturación (ADR §206) ⟦OPUS-4.8⟧** — A0 fix regex SSoT ✅ · A5 shard `30`→`33-LECCIONES-FRONTEND` (acantilado 98%, próx. turno enfocado) · A6 comprimir 00 · A7 GC 10 · **A1-A2 crear `11-GOBERNANZA`+split §G = GATED** (Decisión Fuerte cross-repo: §G es template ×3 repos + 2ª opinión Gemini, prompt en bóveda) | 🔄 | cross-repo + Gemini para A1-A2 |
