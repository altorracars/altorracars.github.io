...
> 🎨 **FOCO: F4/F5 REDISEÑO TOTAL** (Bot widget + ALTOR Hub admin), dueño 24/06 "arcaico/mal responsive/pocas funciones". **TODO-38** EN CURSO (Fase D build); v2 paralelo flag-gated, engine-agnóstico. Detalle → fila TODO-38 + specs `…F4F5-fase{A-D}…` + plan `…EPIC-F4F5-...PLAN`.
